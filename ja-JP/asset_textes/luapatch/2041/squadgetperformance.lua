...
local SquadGetPerformance_InitUIElements = function(self)	
	self:InitUIElements();
	if self.transform:GetComponent(typeof(CS.ImageBufferBlurCheckCanvas)) == nil then
		self.gameObject:AddComponent(typeof(CS.ImageBufferBlurCheckCanvas));
	end
end
...
util.hotfix_ex(CS.SquadGetPerformance,'InitUIElements',SquadGetPerformance_InitUIElements)
