...
local InitUIElements = function(self)
	self:InitUIElements();
	local text1 = self.transform:Find("TheaterNode/AutoLayoutNode/TotalPointNode/BGNode/UI_Text (1)"):GetComponent(typeof(CS.ExText));
	text1.text = CS.Data.GetLang(210123);
end
util.hotfix_ex(CS.TheaterCombatSettlementUIController,'PlayBattleTeamLeader',PlayBattleTeamLeader)
util.hotfix_ex(CS.TheaterCombatSettlementUIController,'InitUIElements',InitUIElements)