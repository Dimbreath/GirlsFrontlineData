...
local gunTable = {"GustafL_1","GustafR_1","GustafM_1","GustafL_2","GustafR_2","GustafM_2","GustafL_3","GustafR_3","GustafM_3"}
local OffsetDataTableX = {0.9,0.4,3.82,-0.59,0.12,2.12,0.54,0.23,2.85}
local OffsetDataTableY = {-1.2,-1.2,0.01,0,0,0,0,0,0.43}
local OffsetDataTableZ = {3.32,2.24,1.41,-0.36,0.79,0.24,0,0.58,0.23}
